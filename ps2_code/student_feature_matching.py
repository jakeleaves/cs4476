...
def match_features(features1, features2):
    ...
    feat1_dim = features1.shape[1]
    feat2_dim = features2.shape[1]
    ...
    for i in range(n):
        ...
        if dists[i][num[0]] / dists[i][num[1]] <= threshold:
            confidences.append(dists[i][num[0]] / dists[i][num[1]])
            matches.append([i, num[0]])
